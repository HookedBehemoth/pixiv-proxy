...
pub fn ugoira(client: &ureq::Agent, id: u64) -> Result<rouille::Response, ApiError> {
    ...
    #[no_mangle]
    unsafe extern "C" fn ReadFunc(opaque: *mut libc::c_void, ptr: *mut u8, sz: i32) -> i32 {
    ...
    #[no_mangle]
    unsafe extern "C" fn NextFunc(opaque: *mut libc::c_void) {
        let opaque = opaque as *mut Opaque<'_>;
    ...
    #[no_mangle]
    unsafe extern "C" fn WriteFunc(opaque: *mut libc::c_void, ptr: *mut u8, sz: i32) -> i32 {
        let opaque = opaque as *mut Opaque<'_>;
    ...
    #[no_mangle]
    unsafe extern "C" fn SeekFunc(opaque: *mut libc::c_void, offset: i64, whence: i32) -> i64 {
        let opaque = opaque as *mut Opaque<'_>;
